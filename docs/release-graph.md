...
two pinned repositories, using exact Git Blob OIDs and content digests rather
than mutable worktree files. The request binds that receipt without claiming that a
