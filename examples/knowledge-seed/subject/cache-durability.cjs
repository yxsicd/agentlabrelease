...
})().catch(error=>{console.log(JSON.stringify({stage,schema:'agentlab.cache_durability_probe.v1',pass:false,error:String(error),checks:{},referenceTransformsApplied:false,actualModulesExecuted:0,qualification:{candidateOnly:true,phoneBuild:false,pageUI:false,actualAgent:false}}));});
